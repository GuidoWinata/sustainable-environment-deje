...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_category_fk` FOREIGN KEY (`category_id`) REFERENCES `product_categories` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `news` (
  ...
  `thumbnail_large` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=12633 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
