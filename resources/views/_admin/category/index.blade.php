                ...
                <div class="table-responsive-sm">
                    <table class="table table-bordered table-hover mt-3 table-sm">
                        <thead class="table-light">
                            <tr>
                                <th class="table-header" style="--width: 80%">Nama Kategori</th>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ base_url($page['route'] . "/update/{$category->id}") }}"
                                                       navigate>Edit</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-danger"
                                                       href="{{ base_url($page['route'] . "/delete/{$category->id}") }}"
                                                       confirm-message="Apakah kamu yakin menghapus {{ $category->name }}?"
